...
{\sf Pkt} the set of packets \pkt, and {\sf Env} the set of environments \env
\begin{align*}
...
\\
\text{where } & \rlap{$\displaystyle\bigotimes\{A_1,\ldots,A_n\}=\{a_1\cup\ldots\cup a_n\mid a_1\in A_1,\ldots,a_n\in A_n\}, a_i\in\mathcal P(\pkt,\env), A_i\in\mathcal P(\mathcal P(\pkt,\env))$}
\end{align*}
