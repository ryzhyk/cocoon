...
"Regular keywords
syn keyword ccnStatement        and bool fork function assume host not or pkt refine role send switch primary table view foreign key check unique references match state drop in with var
